        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    console.log("🚀 ~ file: Weather.jsx:30 ~ useEffect ~ latitude:", latitude)
                    let longitude = position.coords.longitude;
                    console.log("🚀 ~ file: Weather.jsx:32 ~ useEffect ~ longitude:", longitude)
                    setLat(latitude);
                    setLon(longitude);
                    console.log("🚀 ~ file: Weather.jsx:30 ~ useEffect ~ position.coords.latitude:", position.coords.latitude);
                    console.log("🚀 ~ file: Weather.jsx:32 ~ useEffect ~ position.coords.longitude:", position.coords.longitude);
